    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.huodongOrderYesnoTypes" label="审核状态" prop="huodongOrderYesnoTypes">
                        <el-input v-model="ruleForm.huodongOrderYesnoValue" placeholder="审核状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.huodongOrderYesnoText" label="审核结果" prop="huodongOrderYesnoText">
